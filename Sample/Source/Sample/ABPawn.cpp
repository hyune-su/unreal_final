...
AABPawn::AABPawn()
{
	...
	Mesh->SetRelativeLocationAndRotation(FVector(0.0f, 0.0f, -16.0f), FRotator(0.0f, -90.0f, 0.0f));
	...
	("/Game/Anim/WarriorAnim_BP.WarriorAnim_BP_C"));
...
void AABPawn::BeginPlay()
{
	...
	//UAnimationAsset* AnimAsset = LoadObject<UAnimationAsset>(nullptr, TEXT("/Game/Anim/WarriorRun.WarriorRun"));
